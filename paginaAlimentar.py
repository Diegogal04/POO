...
class Alimentar:
    def __init__(self, root): 
        ...
        self.img = tk.PhotoImage(file=os.path.join(directorioRaiz, 'Imagenes', 'Comer.png'))

        self.canvas = tk.Canvas(self.main_window, width=90, height=90, bg="green")
        self.canvas.create_image(0, 0, image=self.img, anchor="nw")
        self.label = tk.Label(self.main_window, text="Pepinillo esta comiendo...")
